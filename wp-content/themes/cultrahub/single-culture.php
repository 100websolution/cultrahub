...
<div class="mainContainer" id="mainContainer">
	...
	<div class="section">
		<div class="container">
			<div class="innerContainer">
				<div class="sliderblockWrap odd rev f14">
					<div class="sliderblock">
						...
						?>
								<div class="item">
									<div class="sliderImgBox">
										...
										<?php echo $embed_code = youtubeEmbedFromUrl($val_psvc['video_url'], '100%', '315px', $b);	//100 means 100% ?>
									</div>
									<div class="sliderTextBox">
										<h2 class="subheading"><?php echo $val_psvc['title'];?></h2>
									</div>
								</div>
						<?php
							$b++;
						...
						<div class="sliderText2">
							<h2 class="heading">Popular Store Clips</h2>
							<div class="">
					...
					<div class="sliderblock">
						...
						?>
								<div class="item">
									...
									<div class="sliderTextBox">
										<h2 class="subheading"><?php echo $val_wsd['title'];?></h2>
									</div>
								</div>
						<?php
							}
						...
						<div class="sliderText2">
							<h2 class="heading">Words of the Street</h2>
							<div class="">
