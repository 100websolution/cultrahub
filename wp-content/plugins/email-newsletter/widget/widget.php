...
<?php /*<div>
  ...
  <?php } ?>
  <?php /*<div class="eemail_button">*/?>
    <input class="" name="eemail_txt_Button" id="eemail_txt_Button" onClick="return eemail_submit_ajax('<?php echo emailnews_plugin_url('widget'); ?>','<?php echo get_option('readygraph_application_id', ''); ?>')" value="<?php echo get_option('eemail_widget_but_cap'); ?>" type="submit">
  <?php /*</div>
</div>*/?>